...
<a class="btn btn-dark btn-sm" href="{{url('/venta/create')}}"><i class="fas fa-user-edit"> Agregar venta</i></a>

<button type="button" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
<i class="fa fa-plus-square-o"> Agregar Venta Modal</i>
    </button>
</div>
<div class="container-sm text-center">
   
    <h3 class="text-center font-weight-bold">Modulo detalle venta</h3><br>
        ...
        <tbody> 
            ...
            <tr>
                ...
                <td>
                 ...
                 <form id="deletebtn" method="POST" action="{{url('/venta/'.$venta->id)}}" class="" name="">      
                    @csrf 
                    @method('DELETE')
                    
                    <a class="btn btn-warning btn-sm" href="{{url('/venta/'.$venta->id.'/edit')}}" role="button"><i class="fas fa-user-edit"></i></a>
                    
                    <button type="button" class="btn btn-success btn-sm" href="{{url('/venta/'.$venta->id)}}" data-bs-toggle="modal" data-bs-target="#exampleModal2">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar detalle venta</h5>
        ...
        <form action="{{url('/venta')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" type="number" name="idProductoFK" id="idProductoFK"><br>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label text-md-end" for="idUsuarioFK">Usuario </label>
                            <div class="col-md-6">
                                <input class="form-control" type="number" name="idUsuarioFK" id="idUsuarioFK"><br>
                            </div>
                        </div>
